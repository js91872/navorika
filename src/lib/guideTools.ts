...
export const guideTools: Record<string, string[]> = {
  ...
  'best-coreldraw-print-format': ['coreldraw-tools', 'cdr-print-readiness-checker', 'cdr-to-pdf-converter', 'cdr-to-eps-converter'],
  'preserve-fonts-coreldraw-conversion': ['word-to-cdr-converter', 'pdf-to-cdr-converter', 'cdr-print-readiness-checker'],
