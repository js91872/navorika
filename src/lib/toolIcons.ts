...
export const toolIcons: Record<string, string> = {
  ...
  'png-to-cdr-converter': '🖼️',
  'jpg-to-cdr-converter': '📷',
  'svg-to-cdr-converter': '✒️',
  'ai-to-cdr-converter': '🅰️',
  'eps-to-cdr-converter': '🖨️',
  'cdr-viewer': '👁️',
  'cdr-version-converter': '🔎',
  'cdr-to-pdf-converter': '📑',
  'cdr-to-svg-converter': '✒️',
  'cdr-to-png-converter': '🖼️',
  'cdr-to-jpg-converter': '📷',
  'cdr-to-eps-converter': '🖨️',
