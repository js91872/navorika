...
export const metadata = {
  title: "Image Tools | Navorika Pro",
  description: "Advanced local utilities deployed within the Image Tools workspace.",
};

export default function CategoryPage() {
  const targetTools = tools.filter(t => t.category === 'image-tools');
  ...
  return (
    <main className="max-w-7xl mx-auto px-6 py-16 lg:px-8">
      ...
      <div className="border-b border-slate-200 dark:border-slate-800 pb-8 mb-12">
        <h1 className="text-4xl font-black text-slate-900 dark:text-white">Image Tools</h1>
