...
export default function PDFCategoryPage() {
  ...
  const tools = allTools.filter(t => t.category === "PDF Tools");
  ...
  return (
    <div className="min-h-screen bg-premium bg-dots py-12">
      <Container>
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100">PDF Tools</h1>
          <p className="text-slate-600 dark:text-slate-400">PDF utilities to merge, split, compress, and convert documents.</p>
