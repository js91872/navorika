...
export const metadata = {
  title: "Developer Tools | Navorika Pro",
  description: "Advanced local utilities deployed within the Developer Tools workspace.",
};

export default function CategoryPage() {
  const targetTools = tools.filter(t => t.category === 'developer-tools');
  ...
  return (
    <main className="max-w-7xl mx-auto px-6 py-16 lg:px-8">
      ...
      <div className="border-b border-slate-200 dark:border-slate-800 pb-8 mb-12">
        <h1 className="text-4xl font-black text-slate-900 dark:text-white">Developer Tools</h1>
