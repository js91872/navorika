      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <div className="relative flex-1 sm:min-w-[200px] lg:min-w-[260px]">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200/80 bg-white/50 pl-9 pr-4 py-2.5 text-sm outline-none transition focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 dark:border-slate-700 dark:bg-slate-800/50 dark:text-slate-200 dark:placeholder:text-slate-500"
              />
            </div>
        ...
        {/* Mobile description */}
        <p className="text-sm text-slate-500 dark:text-slate-400 sm:hidden mb-6">
          Browse our collection of free online tools
        </p>
