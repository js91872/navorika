...
export default function AboutPage() {
  ...
  const stats = [
    ...
    { icon: <Globe className="h-6 w-6" />, value: '0', label: 'Data Uploads' },
  ];
  ...
  const values = [
    ...
    },
    {
      ...
      description: 'Zero server latency. Every tool responds instantly because it runs right where you are.',
    },
    {
      icon: <Rocket className="h-8 w-8" />,
      title: 'Built for the Future',
      description: 'Designed for 2030 and beyond. Modern, fast, and ready for tomorrow\'s web.',
    },
    {
      icon: <Heart className="h-8 w-8" />,
      title: 'User-Centric',
      description: 'Every tool is designed with one goal: making your work easier, faster, and more enjoyable.',
    },
  ];
  ...
  const reasons = [
    {
      ...
      description: 'Everything runs in your browser. We never see your files or data.',
    },
    {
      icon: <CheckCircle className="h-6 w-6 text-emerald-500" />,
      title: 'No Tracking',
      description: 'Zero analytics, zero cookies, zero tracking. Your privacy is absolute.',
    },
    {
      icon: <CheckCircle className="h-6 w-6 text-emerald-500" />,
      title: 'World-Class Tools',
      description: `${toolCount}+ tools covering PDF, images, finance, health, and development.`,
    },
    {
      icon: <CheckCircle className="h-6 w-6 text-emerald-500" />,
      title: 'Open & Transparent',
      description: 'All code runs locally. No hidden processes, no background uploads.',
    },
  ];
    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)] pt-24 pb-16">
      ...
      <section className="relative overflow-hidden px-4 py-16 md:py-24">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            NavorikaPro is redefining what's possible in the browser.
            100% client-side, zero-latency, and built for absolute privacy.
          </motion.p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {stats.map((stat, index) => (
            ...
            >
              <div className="text-indigo-600 dark:text-indigo-400 flex items-center justify-center mb-2">
                {stat.icon}
              </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {values.map((value, index) => (
            ...
            >
              <div className="w-14 h-14 mx-auto rounded-2xl bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                {value.icon}
              </div>
