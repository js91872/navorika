...
export const constructionToolPages: Record<string, ToolPageContent> = {
  ...
  'fence-calculator': {slug:'fence-calculator',...expansionPage({name:'Fence Calculator',description:'Estimate fence sections, panels, total posts, line posts, corner/end/gate posts and optional rails.',keywords:['fence panel and post calculator','fence post spacing calculator','fence gate material estimate'],intro:'Turn a fence run into sections and supporting components while accounting for gates and corners.',formula:'Gate widths are removed from panelized length; remaining length is divided into sections, with boundary posts adjusted for corners and gates.',interpretation:'Line posts and corner/end/gate posts are shown separately under explicit layout assumptions.',limitations:['Irregular terrain, bracing assemblies, double gates and shared corner conditions may change counts.','Confirm property lines, utilities, frost depth, wind design and local requirements.'],relatedTools:[{slug:'post-hole-concrete-calculator',name:'Post Hole Concrete Calculator'},{slug:'construction-estimate-builder',name:'Construction Estimate Builder'}],faq:[{question:'Are gate widths subtracted?',answer:'Yes. Entered gate openings reduce the panelized fence length.'},{question:'What does panel mode do?',answer:'It estimates purchased panels and applies the entered waste percentage.'},{question:'Are gate posts included?',answer:'The planning result reserves two boundary posts per entered gate.'}]})},
  ...
  'paver-calculator': {slug:'paver-calculator',...expansionPage({name:'Paver Calculator',description:'Calculate paver area, base quantity, waste-adjusted quantity and optional pallets from project dimensions.',keywords:['patio paver calculator','paver count by size','pavers per pallet calculator'],intro:'Convert project area and individual paver dimensions into a purchasing count.',formula:'Paver area converts square inches to square feet; project area ÷ paver area rounds up before waste.',interpretation:'Base count covers net geometry; purchase count includes the selected waste percentage.',limitations:['Joint spacing and pattern cuts are represented only through the waste allowance.','Verify actual packaged count, dimensions and pattern coverage with the supplier.'],relatedTools:[{slug:'polymeric-sand-calculator',name:'Polymeric Sand Calculator'},{slug:'sand-calculator',name:'Sand Calculator'}],faq:[{question:'Can I enter known area?',answer:'Yes, or calculate it from project length and width.'},{question:'Does it calculate pallets?',answer:'Yes when you enter the supplier’s pavers-per-pallet quantity.'},{question:'Why add waste?',answer:'Cuts, breakage, pattern layout and future repairs require extra units.'}]})},
  'polymeric-sand-calculator': {slug:'polymeric-sand-calculator',...expansionPage({name:'Polymeric Sand Calculator',description:'Estimate paver joint volume, density-based polymeric sand weight and bags from project and joint geometry.',keywords:['polymeric sand calculator joint width','paver joint sand bag calculator','polymeric sand coverage estimate'],intro:'Model paver-joint fill from total approximate joint length, width and depth.',formula:'Joint volume scales with joint length × width × depth; weight = volume × editable density, then waste is applied.',interpretation:'Increasing joint width or depth increases volume, weight and usually bag count.',limitations:['Manufacturer coverage varies with paver geometry, joint profile, compaction and product formulation.','Use the product data sheet whenever it provides a tested coverage table.'],relatedTools:[{slug:'paver-calculator',name:'Paver Calculator'},{slug:'sand-calculator',name:'Sand Calculator'}],faq:[{question:'Does wider joint spacing use more sand?',answer:'Yes. Weight increases proportionally with entered joint width.'},{question:'Can density be changed?',answer:'Yes. Override the planning density with product information.'},{question:'Is this a manufacturer coverage guarantee?',answer:'No. Product-specific coverage should control purchasing.'}]})},
  ...
  'construction-cost-calculator': {
    ...
    relatedTools: [{ slug: 'house-construction-cost-calculator', name: 'House Construction Cost Calculator' }, { slug: 'flooring-calculator', name: 'Flooring Calculator' }, { slug: 'paint-calculator', name: 'Paint Calculator' }], relatedGuides: [],
  },
  'house-construction-cost-calculator': {
    ...
    relatedTools: [{ slug: 'brick-calculator', name: 'Brick Calculator' }, { slug: 'cement-calculator', name: 'Cement Calculator' }, { slug: 'concrete-calculator', name: 'Concrete Calculator' }, { slug: 'flooring-calculator', name: 'Flooring Calculator' }, { slug: 'roof-area-calculator', name: 'Roof Area Calculator' }], relatedGuides: [],
  },
  ...
  'roof-area-calculator': {
    ...
    relatedTools: [{ slug: 'house-construction-cost-calculator', name: 'House Construction Cost Calculator' }, { slug: 'solar-panel-calculator', name: 'Solar Panel Calculator' }, { slug: 'land-area-converter', name: 'Land Area Converter' }], relatedGuides: [],
  },
  'tile-calculator': {
    slug: 'tile-calculator', name: 'Rectangular Tile Grid Calculator with Joint Gap and Waste', category: 'Construction Calculators', applicationCategory: 'UtilitiesApplication', description: 'Estimate a fixed-orientation rectangular tile grid from room and tile dimensions, joint gap, and a custom waste allowance without assuming tiles per box.',
    ...
    formula: [{ title: 'Tiles along a side', body: 'Ceiling((room side + joint gap) ÷ (tile side + joint gap)).' }, { title: 'Fitted grid', body: 'Tiles along length × tiles along width.' }, { title: 'Order quantity', body: 'Fitted grid × (1 + waste percentage ÷ 100), rounded upward.' }],
    ...
    interpretation: ['The result assumes one fixed tile orientation and shows grid dimensions before waste.', 'Waste is included once in the final tile count.'], limitations: ['Does not optimize alternate orientation, pattern, stagger, diagonal layout, borders, niches, obstacles, or reuse of offcuts.', 'Assumes uniform joints and a rectangular coverage area.', 'Does not calculate boxes because tiles per box vary.'],
    faqs: [{ question: 'Does joint gap affect the result?', answer: 'Yes. It is included in the repeated tile pitch.' }, { question: 'Is waste added twice?', answer: 'No.' }, { question: 'Why are boxes not shown?', answer: 'Packaging varies; divide final tiles by the actual box quantity and round upward.' }, { question: 'Does this optimize cuts?', answer: 'No.' }],
  ...
  'brick-calculator': {
    ...
    relatedTools: [{ slug: 'house-construction-cost-calculator', name: 'House Construction Cost Calculator' }, { slug: 'cement-calculator', name: 'Cement Calculator' }, { slug: 'concrete-calculator', name: 'Concrete Calculator' }, { slug: 'sand-calculator', name: 'Sand Calculator' }], relatedGuides: [],
  },
  'cement-calculator': {
  ...
  'steel-weight-calculator': {
    ...
    intro: ['This calculator multiplies an ideal cross-sectional area by a fixed steel density of 7,850 kg/m³, total length, and quantity.', 'Round, square, and rectangular options model solid bars. The I-section option uses one thickness for both flanges and the web and treats the entered web height as the clear web height.'],
    formula: [{ title: 'Linear mass', body: 'Cross-sectional area in m² × 7,850 kg/m³.' }, { title: 'Total mass', body: 'Linear mass × length per piece × quantity.' }],
  ...
  'flooring-calculator': {
    ...
    relatedTools: [{ slug: 'house-construction-cost-calculator', name: 'House Construction Cost Calculator' }, { slug: 'tile-calculator', name: 'Tile Calculator' }, { slug: 'paint-calculator', name: 'Paint Calculator' }, { slug: 'land-area-converter', name: 'Land Area Converter' }], relatedGuides: [],
  },
  'paint-calculator': {
    slug: 'paint-calculator', name: 'Room Wall and Ceiling Paint Calculator', category: 'Construction Calculators', applicationCategory: 'UtilitiesApplication', description: 'Estimate paint litres for four rectangular room walls plus the ceiling using dimensions, coats, product coverage, and a custom waste allowance.',
    ...
    intro: ['The paint calculator totals the four wall faces and ceiling of a rectangular room, multiplies by the number of coats, and divides by entered coverage.', 'It adds a waste allowance and shows an indicative count of five-litre containers.'],
    formula: [{ title: 'Surface area', body: '2 × height × (length + width) + length × width for the ceiling.' }, { title: 'Paint volume', body: 'Surface area × coats ÷ coverage × (1 + waste percentage ÷ 100).' }],
    ...
    interpretation: ['The estimate deliberately includes the ceiling and does not subtract doors or windows.', 'Coverage varies with paint, substrate, preparation, application method, and colour change.'], limitations: ['Assumes a rectangular room with uniform height.', 'Does not model doors, windows, trim, floors, feature walls, primer, texture, absorption, or separate products.', 'Five-litre can count is illustrative; purchase sizes differ.'],
    faqs: [{ question: 'Does the area include the ceiling?', answer: 'Yes.' }, { question: 'Are doors and windows deducted?', answer: 'No.' }, { question: 'Where should coverage come from?', answer: 'Use the specific coating manufacturer’s data for the surface and method.' }, { question: 'Is primer included?', answer: 'No.' }],
  ...
  'water-tank-calculator': {
    ...
    relatedTools: [{ slug: 'land-area-converter', name: 'Land Area Converter' }, { slug: 'sand-calculator', name: 'Sand Calculator' }, { slug: 'gravel-calculator', name: 'Gravel Calculator' }], relatedGuides: [],
  },
  'sand-calculator': {
    slug: 'sand-calculator', name: 'Sand Volume, Weight, Bag and Truck Estimate', category: 'Construction Calculators', applicationCategory: 'UtilitiesApplication', description: 'Estimate rectangular sand volume and weight from dimensions and a custom bulk density, with indicative 25 kg bags and 15-tonne loads.',
    ...
    intro: ['The sand calculator converts entered dimensions to metres, multiplies them for rectangular volume, and applies the entered bulk density.', 'Bag and truck figures are simple divisions using fixed 25 kg bags and 15,000 kg loads.'],
    formula: [{ title: 'Volume', body: 'Length × width × depth in metres.' }, { title: 'Weight', body: 'Volume in m³ × entered density in kg/m³.' }],
    ...
    interpretation: ['Moisture, grading, compaction, and voids can materially change bulk density.', 'Rounded bag and truck counts do not include supplier packaging or vehicle payload constraints.'], limitations: [...planningLimits, 'No bulking, compaction, moisture, waste, or irregular-shape factor is included.', 'The 25 kg bag and 15-tonne truck assumptions may not match local supply.'],
    faqs: [{ question: 'Which density should I enter?', answer: 'Use a supplier or test value for the actual material and condition.' }, { question: 'Are truck loads exact?', answer: 'No. They assume 15,000 kg per load.' }, { question: 'Is waste included?', answer: 'No.' }, { question: 'Can it model irregular areas?', answer: 'No. Divide them into measured shapes or obtain a survey.' }],
  ...
  'gravel-calculator': {
    ...
    relatedTools: [{ slug: 'cement-calculator', name: 'Cement Calculator' }, { slug: 'concrete-calculator', name: 'Concrete Calculator' }, { slug: 'sand-calculator', name: 'Sand Calculator' }, { slug: 'asphalt-calculator', name: 'Asphalt Calculator' }], relatedGuides: [],
  },
  'asphalt-calculator': {
    ...
    relatedTools: [{ slug: 'gravel-calculator', name: 'Gravel Calculator' }, { slug: 'sand-calculator', name: 'Sand Calculator' }], relatedGuides: [],
  },
};
