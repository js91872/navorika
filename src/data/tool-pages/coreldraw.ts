...
export const corelDrawToolPages: Record<string, ToolPageContent> = {
  ...
  'pdf-to-cdr-converter': {
    ...
    name: 'PDF to CDR Converter – Convert PDF for CorelDRAW Online',
    category: 'Developer Tools',
    applicationCategory: 'DesignApplication',
    description:
      'Convert PDF to CorelDRAW online for free. Prepare multipage PDF, editable SVG vectors, or EPS files to import and save as CDR. Fast, private, CorelDRAW-ready.',
    longTailKeywords: [
      'pdf to cdr',
      'pdf to cdr converter',
  ...
  'jpg-to-cdr-converter': {
    ...
    faqs: [
      ...
      {
        question: 'Can I import CMYK JPEGs into CorelDRAW using this tool?',
        answer: 'Yes. However, if your JPEG is destined for web or digital presentation, it should be in sRGB. If preparing for commercial offset printing, CorelDRAW natively handles CMYK JPEGs once placed. You can preflight your image color space with our RGB CMYK Image Checker.',
      },
      {
