...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: 'Plan your monthly budget and track expenses. Calculate savings and manage cash flow.',
  ...
  },
  {
    ...
    description: 'Minify or beautify JavaScript, CSS, and HTML code. Optimize your code for production.',
    category: 'developer-tools',
  ...
  },
  {
    ...
    description: 'Extract colors from images easily. Generate color palettes and get hex codes.',
    category: 'image-tools',
  ...
  },
  {
    ...
    description: 'Create custom icons and stickers from images. Design unique stickers and icons for your projects.',
    category: 'image-tools',
  ...
  },
  {
    ...
    description: 'Create professional passport, visa, and ID photos with correct dimensions.',
    category: 'image-tools',
  ...
  },
  {
    ...
    description: 'Calculate investment returns with compounding. Plan your investment strategy.',
    category: 'finance-calculators',
  ...
  },
  {
    ...
    title: 'JWT Decoder',
    description: 'Decode JWT tokens online. Parse JSON Web Tokens and view payload data instantly.',
    category: 'developer-tools',
  ...
  },
  {
    ...
    description: 'Format HTML and markup code for readability. Clean and format your markup code online.',
    category: 'developer-tools',
  ...
  },
  {
    ...
    description: 'Generate QR codes instantly. Create custom QR codes for URLs, text, and more. Free online QR code generator.',
    category: 'developer-tools',
  ...
  },
  {
    ...
    description: 'Resize images for social media platforms. Create perfect images for Instagram, Facebook, and more.',
    category: 'image-tools',
  ...
  },
  {
    ...
    description: 'Calculate income tax, GST, and other taxes. Plan your tax strategy with accurate calculations.',
    category: 'finance-calculators',
  ...
  },
  {
    ...
    description: 'View, format, and validate JSON data online. Pretty-print JSON with syntax highlighting.',
    category: 'developer-tools',
  ...
  },
  {
    ...
    description: 'Calculate how inflation affects your savings. Understand the impact of inflation over time.',
    category: 'finance-calculators',
  ...
  },
  {
    ...
    description: 'Encrypt, decrypt, hash, and generate secure keys using Web Crypto API.',
    category: 'developer-tools',
  ...
  },
  {
    ...
    description: 'Generate SEO-friendly meta tags for your website. Create title tags, descriptions, and more.',
    category: 'developer-tools',
