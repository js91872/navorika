...
export const clusters: ToolCluster[] = [
  ...
  { id: 'developer-security', name: 'Security, Tokens, and IDs', description: 'Generate identifiers, inspect tokens, use browser cryptography, and create scannable codes.', category: 'developer-tools', toolSlugs: ['uuid-generator', 'jwt-decoder', 'qr-code-generator', 'web-crypto-studio', 'uuid-generator-validator'] },
