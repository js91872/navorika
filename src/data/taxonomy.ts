...
export const complementaryTools: Record<string, string[]> = {
  ...
  'pdf-bleed-trim-checker': ['pdf-page-size-checker', 'crop-pdf', 'print-bleed-calculator'],
  'cdr-print-readiness-checker': ['coreldraw-tools', 'cdr-version-converter', 'print-bleed-calculator'],
  'svg-dimensions-checker': ['image-scaling-calculator', 'image-print-size-calculator', 'svg-to-png'],
