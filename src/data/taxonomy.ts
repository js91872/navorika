...
export const clusters: ToolCluster[] = [
  ...
  { id: 'finance-loans', name: 'Loans and Amortization', description: 'Estimate repayments, interest costs, and amortization schedules.', category: 'finance-calculators', toolSlugs: ['loan-emi-calculator', 'loan-amortization-suite', 'mortgage-affordability-calculator'] },
  { id: 'finance-retirement', name: 'Savings and Retirement', description: 'Plan longer-term savings targets and retirement funding.', category: 'finance-calculators', toolSlugs: ['retirement-calculator', 'savings-retirement-hub', 'savings-goal-calculator'] },
  { id: 'finance-tax', name: 'Tax and Business Finance', description: 'Estimate tax, GST, and compliance-related figures for planning.', category: 'finance-calculators', toolSlugs: ['gst-calculator', 'tax-calculator', 'taxation-compliance-deck', 'break-even-calculator', 'profit-margin-markup-calculator'] },
  ...
  { id: 'health-energy', name: 'Energy and Nutrition', description: 'Estimate resting energy, daily expenditure, and calorie targets.', category: 'health-calculators', toolSlugs: ['bmr-calculator', 'calorie-calculator', 'tdee-calculator', 'caffeine-half-life-calculator', 'macronutrient-calculator', 'hydration-calculator'] },
  ...
  { id: 'developer-json', name: 'JSON and Tabular Data', description: 'Format, validate, compare, flatten, and convert JSON and CSV data.', category: 'developer-tools', toolSlugs: ['json-formatter', 'json-schema-validator', 'json-diff-compare', 'json-to-csv-flattener', 'csv-to-json-converter', 'yaml-json-converter'] },
  { id: 'developer-config-data', name: 'Configuration and Data Interchange', description: 'Convert and validate configuration formats including JSON, YAML, and TOML locally in your browser.', category: 'developer-tools', toolSlugs: ['json-to-yaml-converter', 'yaml-to-json-converter', 'json-to-toml-converter', 'toml-to-json-converter', 'yaml-validator'] },
  ...
  { id: 'coreldraw-cdr-tools', name: 'CorelDRAW and CDR Tools', description: 'Prepare CorelDRAW-ready interchange files, preview supported CDR documents, inspect versions, and export open formats without fake native CDR files.', category: 'developer-tools', toolSlugs: ['coreldraw-tools', 'pdf-to-cdr-converter', 'word-to-cdr-converter', 'png-to-cdr-converter', 'jpg-to-cdr-converter', 'svg-to-cdr-converter', 'ai-to-cdr-converter', 'eps-to-cdr-converter', 'cdr-viewer', 'cdr-version-converter', 'cdr-to-pdf-converter', 'cdr-to-svg-converter', 'cdr-to-png-converter', 'cdr-to-jpg-converter', 'cdr-to-eps-converter', 'cdr-print-readiness-checker'] },
  { id: 'developer-encoding', name: 'Text and URL Encoding', description: 'Encode and decode Base64, URLs, and HTML entities locally.', category: 'developer-tools', toolSlugs: ['base64-encoder', 'url-encoder-decoder', 'html-entity-encoder-decoder', 'utf8-vs-utf16-byte-calculator', 'url-parser'] },
  { id: 'developer-number-systems', name: 'Number Systems and Base Conversion', description: 'Convert between binary, decimal, and hexadecimal with step-by-step educational explanations.', category: 'developer-tools', toolSlugs: ['binary-to-decimal-with-steps'] },
  { id: 'developer-networking', name: 'Networking and IP Addressing', description: 'Plan CIDR, subnet, wildcard, VLSM, IPv6 prefix, port range, service lookup, and IP classification workflows.', category: 'developer-tools', toolSlugs: ['cidr-subnet-wildcard-calculator', 'ip-range-calculator', 'vlsm-subnet-calculator', 'mac-address-generator', 'ipv6-subnet-calculator', 'tcp-udp-port-range-calculator', 'cidr-summarization-calculator', 'ip-address-classifier', 'common-port-service-lookup'] },
  { id: 'developer-scheduling', name: 'Cron and Time', description: 'Understand cron schedules, calculate upcoming runs, and convert Unix timestamps.', category: 'developer-tools', toolSlugs: ['cron-next-run-calculator', 'cron-expression-humanizer', 'unix-timestamp-converter', 'epoch-time-converter', 'cron-expression-generator'] },
  ...
  { id: 'developer-security', name: 'Security, Tokens, and IDs', description: 'Generate identifiers, inspect tokens, use browser cryptography, and create scannable codes.', category: 'developer-tools', toolSlugs: ['uuid-generator', 'jwt-decoder', 'qr-code-generator', 'web-crypto-studio', 'uuid-generator-validator', 'ulid-generator'] },
  { id: 'developer-web', name: 'Web and SEO', description: 'Build responsive CSS, metadata, campaign URLs, and crawler directives.', category: 'developer-tools', toolSlugs: ['aspect-ratio-padding-calculator', 'css-clamp-font-generator', 'css-flexbox-generator', 'css-gradient-generator', 'meta-tag-generator', 'robots-txt-generator', 'utm-builder', 'webmaster-seo-builder', 'psd-to-html'] },
  ...
  { id: 'construction-site', name: 'Site and Earthworks', description: 'Estimate site area, excavation, asphalt, aggregate, and storage quantities.', category: 'construction-calculators', toolSlugs: ['asphalt-calculator', 'excavation-calculator', 'gravel-calculator', 'land-area-converter', 'water-tank-calculator', 'rainwater-harvesting-calculator'] },
...
export const toolkits: Toolkit[] = [
  ...
  },
  {
    ...
    groups: [
      ...
      { name: 'Networking and schedules', description: 'Plan IPv4 ranges and subnets, generate MAC addresses, and understand cron schedules.', toolSlugs: ['cidr-subnet-wildcard-calculator', 'ip-range-calculator', 'vlsm-subnet-calculator', 'mac-address-generator', 'cron-next-run-calculator', 'cron-expression-humanizer', 'unix-timestamp-converter', 'http-status-code-lookup', 'ipv6-subnet-calculator', 'tcp-udp-port-range-calculator', 'cidr-summarization-calculator', 'ip-address-classifier', 'common-port-service-lookup'] },
    ...
    ], guideSlugs: ['json-formatting-guide', 'base64-encoding-guide', 'jwt-decoding-guide', 'seo-tools-guide', 'word-to-cdr-formatting-guide', 'pdf-to-cdr-editing-guide', 'raster-image-to-cdr-guide', 'svg-vs-cdr-guide', 'open-cdr-without-coreldraw', 'newer-cdr-older-coreldraw', 'best-coreldraw-print-format', 'preserve-fonts-coreldraw-conversion', 'psd-to-html-guide', 'psd-to-html-email-guide'],
  },
  {
...
export const complementaryTools: Record<string, string[]> = {
  'coreldraw-tools': ['pdf-to-cdr-converter', 'cdr-viewer', 'cdr-to-pdf-converter', 'cdr-version-converter'],
  'pdf-to-cdr-converter': ['cdr-to-pdf-converter', 'svg-to-cdr-converter', 'word-to-cdr-converter', 'coreldraw-tools'],
  'word-to-cdr-converter': ['pdf-to-cdr-converter', 'svg-to-cdr-converter', 'cdr-viewer', 'coreldraw-tools'],
  'png-to-cdr-converter': ['jpg-to-cdr-converter', 'svg-to-cdr-converter', 'pdf-to-cdr-converter', 'coreldraw-tools'],
  'jpg-to-cdr-converter': ['png-to-cdr-converter', 'svg-to-cdr-converter', 'pdf-to-cdr-converter', 'coreldraw-tools'],
  'svg-to-cdr-converter': ['cdr-to-svg-converter', 'pdf-to-cdr-converter', 'png-to-cdr-converter', 'coreldraw-tools'],
  'ai-to-cdr-converter': ['eps-to-cdr-converter', 'svg-to-cdr-converter', 'pdf-to-cdr-converter', 'coreldraw-tools'],
  'eps-to-cdr-converter': ['ai-to-cdr-converter', 'svg-to-cdr-converter', 'pdf-to-cdr-converter', 'coreldraw-tools'],
  'cdr-viewer': ['cdr-version-converter', 'cdr-to-pdf-converter', 'cdr-to-png-converter', 'coreldraw-tools'],
  'cdr-version-converter': ['cdr-viewer', 'cdr-to-pdf-converter', 'coreldraw-tools', 'cdr-print-readiness-checker'],
  'cdr-to-pdf-converter': ['pdf-to-cdr-converter', 'cdr-viewer', 'cdr-to-svg-converter', 'coreldraw-tools'],
  'cdr-to-svg-converter': ['svg-to-cdr-converter', 'cdr-to-pdf-converter', 'cdr-viewer', 'coreldraw-tools'],
  'cdr-to-png-converter': ['cdr-to-jpg-converter', 'cdr-viewer', 'cdr-to-pdf-converter', 'coreldraw-tools'],
  'cdr-to-jpg-converter': ['cdr-to-png-converter', 'cdr-viewer', 'cdr-to-pdf-converter', 'coreldraw-tools'],
  ...
  'ipv6-subnet-calculator': ['cidr-subnet-wildcard-calculator', 'vlsm-subnet-calculator', 'ip-address-classifier'],
  'tcp-udp-port-range-calculator': ['common-port-service-lookup', 'cidr-subnet-wildcard-calculator'],
  'cidr-summarization-calculator': ['cidr-subnet-wildcard-calculator', 'ip-range-calculator', 'vlsm-subnet-calculator'],
  'ip-address-classifier': ['ipv6-subnet-calculator', 'cidr-subnet-wildcard-calculator', 'ip-range-calculator'],
  'common-port-service-lookup': ['tcp-udp-port-range-calculator', 'http-status-code-lookup'],
  'url-parser': ['url-encoder-decoder', 'utm-builder', 'base64-encoder'],
  'pdf-bleed-trim-checker': ['pdf-page-size-checker', 'crop-pdf', 'print-bleed-calculator', 'cdr-print-readiness-checker'],
  'cdr-print-readiness-checker': ['coreldraw-tools', 'cdr-version-converter', 'print-bleed-calculator', 'cdr-to-pdf-converter'],
  'svg-dimensions-checker': ['image-scaling-calculator', 'image-print-size-calculator', 'svg-to-png', 'svg-to-cdr-converter'],
  ...
  'mortar-calculator': ['brick-calculator', 'concrete-block-calculator', 'cement-calculator'],
  'concrete-block-calculator': ['mortar-calculator', 'concrete-calculator', 'rebar-calculator'],
  'rainwater-harvesting-calculator': ['roof-area-calculator', 'water-tank-calculator'],
  'lumpsum-investment-calculator': ['sip-calculator', 'savings-goal-calculator', 'drawdown-recovery-calculator'],
  'savings-goal-calculator': ['lumpsum-investment-calculator', 'sip-calculator', 'cashflow-budget-architect'],
  'mortgage-affordability-calculator': ['loan-emi-calculator', 'rental-property-cash-flow-calculator', 'house-hacking-effective-rent-calculator'],
  'break-even-calculator': ['profit-margin-markup-calculator', 'saas-burn-rate-calculator', 'short-term-rental-break-even-calculator'],
  'profit-margin-markup-calculator': ['break-even-calculator', 'contractor-estimate-generator', 'construction-estimate-builder'],
  'responsive-srcset-generator': ['social-media-resizer', 'image-scaling-calculator', 'change-image-resolution'],
  'yaml-json-converter': ['csv-to-json-converter', 'json-formatter', 'json-schema-validator'],
  'uuid-generator-validator': ['uuid-generator', 'web-crypto-studio', 'mac-address-generator'],
  'macronutrient-calculator': ['calorie-calculator', 'tdee-calculator', 'bmr-calculator'],
  'running-pace-calculator': ['running-calories-calculator', 'walking-calories-calculator', 'heart-rate-calculator'],
  'one-rep-max-calculator': ['barbell-plate-calculator', 'wilks-dots-powerlifting-calculator', 'lean-body-mass-calculator'],
  'hydration-calculator': ['calorie-calculator', 'tdee-calculator', 'running-pace-calculator'],
  'json-to-yaml-converter': ['yaml-to-json-converter', 'json-to-toml-converter', 'yaml-validator', 'json-formatter'],
  'yaml-to-json-converter': ['json-to-yaml-converter', 'toml-to-json-converter', 'yaml-validator', 'json-formatter'],
  'json-to-toml-converter': ['toml-to-json-converter', 'json-to-yaml-converter', 'json-formatter'],
  'toml-to-json-converter': ['json-to-toml-converter', 'yaml-to-json-converter', 'json-formatter'],
  'yaml-validator': ['yaml-to-json-converter', 'json-to-yaml-converter', 'markup-formatter'],
  'epoch-time-converter': ['unix-timestamp-converter', 'cron-next-run-calculator', 'cron-expression-generator'],
