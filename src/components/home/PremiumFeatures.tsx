...
const features = [
  {
    ...
    description: "Instant calculations with no loading delays",
    color: "from-yellow-500 to-orange-500",
  },
  {
    icon: Shield,
    title: "100% Secure",
    description: "All calculations are client-side and private",
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className={`group relative overflow-hidden rounded-2xl bg-slate-50 dark:bg-slate-800/50 p-8 border border-slate-200/50 dark:border-slate-700/50 hover:shadow-xl transition-all duration-500 hover:-translate-y-1 transition-all duration-700 opacity-0 translate-y-10`}
              style={{ 
