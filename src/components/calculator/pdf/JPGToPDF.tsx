      ...
      <div className="p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        {!file ? (
          ...
          >
            ...
            <p className="mt-2 text-slate-600 dark:text-slate-400">Drop your JPG here, or click to browse</p>
            <p className="text-sm text-slate-400 dark:text-slate-500">Select a JPG image to convert</p>
          ...
          <div className="space-y-4">
            ...
            {convertedUrl && (
              <div className="rounded-xl border border-success-200 dark:border-success-800 bg-success-50 dark:bg-success-950/20 p-4 text-success-700 dark:text-success-400 flex items-center gap-3">
                ...
                <span>JPG converted to PDF successfully! Click Download to save.</span>
              </div>
            )}
          </div>
        )}
