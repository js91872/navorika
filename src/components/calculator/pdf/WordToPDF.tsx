...
import { Upload, X, FileText, Download, Loader2, CheckCircle, FileUp } from "lucide-react";
...
export default function WordToPDF() {
  ...
  const convertToPDF = async () => {
    ...
    try {
      ...
      const dummyBlob = new Blob(["Converted PDF content"], { type: "application/pdf" });
      ...
      <div className="p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        {!file ? (
          ...
          >
            ...
            <p className="mt-2 text-slate-600 dark:text-slate-400">Drop your Word file here, or click to browse</p>
            <p className="text-sm text-slate-400 dark:text-slate-500">Select a .doc or .docx file</p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              <Button onClick={convertToPDF} disabled={isConverting} className="flex-1">
                {isConverting ? (
                  <>
            ...
            {convertedUrl && (
              <div className="rounded-xl border border-success-200 dark:border-success-800 bg-success-50 dark:bg-success-950/20 p-4 text-success-700 dark:text-success-400 flex items-center gap-3">
                ...
                <span>Word converted to PDF successfully! Click Download to save.</span>
              </div>
            )}
          </div>
        )}
