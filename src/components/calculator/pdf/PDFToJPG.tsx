...
export default function PDFToJPG() {
  ...
  const convertToJPG = async () => {
    ...
    try {
      ...
      const dummyBlob = new Blob(["Converted JPG content"], { type: "image/jpeg" });
        ...
        {!file ? (
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              <Button onClick={convertToJPG} disabled={isConverting} className="flex-1">
                {isConverting ? (
                  <>
            ...
            {convertedUrl && (
              <div className="rounded-xl border border-success-200 dark:border-success-800 bg-success-50 dark:bg-success-950/20 p-4 text-success-700 dark:text-success-400 flex items-center gap-3">
                ...
                <span>PDF converted to JPG successfully! Click Download to save.</span>
              </div>
            )}
          </div>
        )}
