...
export default function ExpansionToolPage({ category, eyebrow, title, description, children }: { category: 'developer-tools' | 'construction-calculators'; eyebrow: string; title: string; description: string; children: React.ReactNode }) {
  const categoryName = category === 'developer-tools' ? 'Developer Tools' : 'Construction Calculators';
