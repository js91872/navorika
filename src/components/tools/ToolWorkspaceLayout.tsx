  ...
  return (
    <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-8 pb-6 border-b border-slate-200">
        ...
        <p className="text-slate-600 mt-2 text-sm sm:text-base max-w-3xl leading-relaxed">{description}</p>
      </div>

      {/* Main Wide-Screen Ergonomic Workspace Container */}
      <div className="w-full bg-white border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-xl shadow-slate-200/50">
        {children}
      </div>
    </div>
  );
